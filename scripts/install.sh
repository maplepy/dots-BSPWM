...
git clone --bare "https://github.com/maplepy/dots-BSPWM" "$HOME/$folder"
...
if [[ "$git_ask" == "y" ]]; then
    ...
    $dots_cmd remote set-url origin git@github.com:maplepy/dots-bspwm.git
fi
...
bspc wm -r && notify-send -u critical Installation "Installation should be complete now\nPlease reboot when you're ready"